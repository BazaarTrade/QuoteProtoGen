...
const (
	...
	Quote_StreamPrecisedOrderBookSnapshots_FullMethodName = "/pbQ.Quote/StreamPrecisedOrderBookSnapshots"
...
type QuoteClient interface {
	...
	StreamPrecisedOrderBookSnapshots(ctx context.Context, in *Pair, opts ...grpc.CallOption) (grpc.ServerStreamingClient[PrecisedOrderBookSnapshots], error)
...
func (c *quoteClient) StreamPrecisedOrderBookSnapshots(ctx context.Context, in *Pair, opts ...grpc.CallOption) (grpc.ServerStreamingClient[PrecisedOrderBookSnapshots], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Quote_ServiceDesc.Streams[1], Quote_StreamPrecisedOrderBookSnapshots_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Quote_StreamPrecisedOrderBookSnapshotsClient = grpc.ServerStreamingClient[PrecisedOrderBookSnapshots]
...
type QuoteServer interface {
	...
	StreamPrecisedOrderBookSnapshots(*Pair, grpc.ServerStreamingServer[PrecisedOrderBookSnapshots]) error
...
func (UnimplementedQuoteServer) StreamPrecisedOrderBookSnapshots(*Pair, grpc.ServerStreamingServer[PrecisedOrderBookSnapshots]) error {
	return status.Errorf(codes.Unimplemented, "method StreamPrecisedOrderBookSnapshots not implemented")
}
...
func _Quote_StreamPrecisedOrderBookSnapshots_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(Pair)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(QuoteServer).StreamPrecisedOrderBookSnapshots(m, &grpc.GenericServerStream[Pair, PrecisedOrderBookSnapshots]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Quote_StreamPrecisedOrderBookSnapshotsServer = grpc.ServerStreamingServer[PrecisedOrderBookSnapshots]
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _Quote_StreamPrecisedTrades_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "StreamPrecisedOrderBookSnapshots",
			Handler:       _Quote_StreamPrecisedOrderBookSnapshots_Handler,
			ServerStreams: true,
		},
		{
